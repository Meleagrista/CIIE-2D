...
from utils.constants import FONT_SIZE, MENU_LEFT, MENU_GAP, TITLE_SIZE, FONT_COLOR, TEXT_VERTICAL_CORRECTION
...
class TextoPlay(Text):
    def __init__(self, screen):
        font = pygame.font.Font(FONT, FONT_SIZE)
        pos = (pygame.display.Info().current_w * MENU_LEFT, 0 + (FONT_SIZE * TEXT_VERTICAL_CORRECTION) + MENU_GAP * 0)
...
class TextoConfiguration(Text):
    def __init__(self, screen):
        font = pygame.font.Font(FONT, FONT_SIZE)
        pos = (pygame.display.Info().current_w * MENU_LEFT, 0 + (FONT_SIZE * TEXT_VERTICAL_CORRECTION) + MENU_GAP * 1)
...
class TextoCredits(Text):
    def __init__(self, screen):
        font = pygame.font.Font(FONT, FONT_SIZE)
        pos = (pygame.display.Info().current_w * MENU_LEFT, 0 + (FONT_SIZE * TEXT_VERTICAL_CORRECTION) + MENU_GAP * 2)
...
class TextoExit(Text):
    def __init__(self, screen):
        font = pygame.font.Font(FONT, FONT_SIZE)
        pos = (pygame.display.Info().current_w * MENU_LEFT, 0 + (FONT_SIZE * TEXT_VERTICAL_CORRECTION) + MENU_GAP * 3)
